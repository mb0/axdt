...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>As3 Break Statement</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.axdt.as3.model.impl.As3BreakStatementImpl#getVsemi <em>Vsemi</em>}</li>
 *   <li>{@link org.axdt.as3.model.impl.As3BreakStatementImpl#getLabelName <em>Label Name</em>}</li>
 *   <li>{@link org.axdt.as3.model.impl.As3BreakStatementImpl#getLabel <em>Label</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class As3BreakStatementImpl extends MinimalEObjectImpl.Container implements As3BreakStatement {
	/**
	 ...
	 * @generated
	 */
	protected As3BreakStatementImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return As3EPackage.Literals.AS3_BREAK_STATEMENT;
	}
	...
	public void setVsemi(String newVsemi) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, As3EPackage.AS3_BREAK_STATEMENT__VSEMI, oldVsemi, vsemi));
	}
	...
	public void setLabelName(String newLabelName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, As3EPackage.AS3_BREAK_STATEMENT__LABEL_NAME, oldLabelName, labelName));
	}
	...
	public As3LabeledStatement getLabel() {
		if (label != null && label.eIsProxy()) {
			...
			if (label != oldLabel) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, As3EPackage.AS3_BREAK_STATEMENT__LABEL, oldLabel, label));
			}
		}
		return label;
	}
	...
	public void setLabel(As3LabeledStatement newLabel) {
		...
		label = newLabel;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, As3EPackage.AS3_BREAK_STATEMENT__LABEL, oldLabel, label));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case As3EPackage.AS3_BREAK_STATEMENT__VSEMI:
				return getVsemi();
			case As3EPackage.AS3_BREAK_STATEMENT__LABEL_NAME:
				return getLabelName();
			case As3EPackage.AS3_BREAK_STATEMENT__LABEL:
