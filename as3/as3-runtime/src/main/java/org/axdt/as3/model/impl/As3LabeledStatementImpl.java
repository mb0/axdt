...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>As3 Labeled Statement</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class As3LabeledStatementImpl extends MinimalEObjectImpl.Container implements As3LabeledStatement {
	/**
	 ...
	 * @generated
	 */
	protected As3LabeledStatementImpl() {
		super();
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, As3EPackage.AS3_LABELED_STATEMENT__NAME, oldName, name));
	}
	...
	public NotificationChain basicSetStatement(IStatement newStatement, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, As3EPackage.AS3_LABELED_STATEMENT__STATEMENT, oldStatement, newStatement);
	...
	public void setStatement(IStatement newStatement) {
		if (newStatement != statement) {
			...
			if (statement != null)
				msgs = ((InternalEObject)statement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - As3EPackage.AS3_LABELED_STATEMENT__STATEMENT, null, msgs);
			if (newStatement != null)
				msgs = ((InternalEObject)newStatement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - As3EPackage.AS3_LABELED_STATEMENT__STATEMENT, null, msgs);
			msgs = basicSetStatement(newStatement, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, As3EPackage.AS3_LABELED_STATEMENT__STATEMENT, newStatement, newStatement));
	}
