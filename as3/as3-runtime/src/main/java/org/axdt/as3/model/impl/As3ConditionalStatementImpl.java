 ...
 * <ul>
 *   <li>{@link org.axdt.as3.model.impl.As3ConditionalStatementImpl#getVsemi <em>Vsemi</em>}</li>
...
public abstract class As3ConditionalStatementImpl extends MinimalEObjectImpl.Container implements As3ConditionalStatement {
	...
	public void setVsemi(String newVsemi) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, As3EPackage.AS3_CONDITIONAL_STATEMENT__VSEMI, oldVsemi, vsemi));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case As3EPackage.AS3_CONDITIONAL_STATEMENT__VSEMI:
				return getVsemi();
			case As3EPackage.AS3_CONDITIONAL_STATEMENT__CONDITIONS:
