...
public class As3Formatter extends AbstractDeclarativeFormatter {
	...
	protected void configureFormatting(FormattingConfig c) {
		...
		c.setLinewrap(1,1,2).after(f.getAs3OperationSignatureAccess().getSemicolonKeyword_12());
		c.setNoSpace().before(f.getAs3OperationSignatureAccess().getSemicolonKeyword_12());
		...
		// metadata
		c.setNoSpace().bounds(f.getAs3MetadataTagAccess().getLeftSquareBracketKeyword_0(),
				f.getAs3MetadataTagAccess().getRightSquareBracketKeyword_3());
		c.setNoSpace().around(f.getAs3MetadataTagAccess().getLeftParenthesisKeyword_2_0());
		c.setNoSpace().around(f.getAs3MetadataTagAccess().getRightParenthesisKeyword_2_3());
		c.setLinewrap(1,0,1).after(f.getAs3MetadataTagAccess().getRightSquareBracketKeyword_3());
		...
		c.setIndentation(f.getAs3ClassAccess().getLeftCurlyBracketKeyword_7(), f
				.getAs3ClassAccess().getRightCurlyBracketKeyword_10());
		c.setLinewrap(1,2,2).after(f.getAs3ClassAccess().getLeftCurlyBracketKeyword_7());
		c.setLinewrap(0,0,1).before(f.getAs3ClassAccess().getLeftCurlyBracketKeyword_7());
		c.setLinewrap().after(f.getAs3ClassAccess().getRightCurlyBracketKeyword_10());
		c.setIndentation(f.getAs3InterfaceAccess().getLeftCurlyBracketKeyword_6(), f
				.getAs3InterfaceAccess().getRightCurlyBracketKeyword_9());
		c.setLinewrap(1,2,2).after(f.getAs3InterfaceAccess().getLeftCurlyBracketKeyword_6());
		c.setLinewrap(0,0,1).before(f.getAs3InterfaceAccess().getLeftCurlyBracketKeyword_6());
		...
		c.setIndentation(f.getAs3OperationAccess().getLeftParenthesisKeyword_6(),
				f.getAs3OperationAccess().getRightParenthesisKeyword_9());
		c.setIndentation(f.getAs3OperationAccess().getFunctionKeyword_1(),
				f.getAs3OperationAccess().getBodyAssignment_12());
